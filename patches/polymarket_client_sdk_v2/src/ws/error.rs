...
pub enum WsError {
    ...
    /// A subscriber fell behind the broadcast buffer.
    Lagged {
        /// Number of messages skipped before the receiver caught up.
        missed: u64,
    },
}
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::Lagged { missed } => {
                write!(
                    f,
                    "WebSocket subscription lagged and missed {missed} messages"
                )
            }
        }
    }
