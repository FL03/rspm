...
mod decimal_blank_string_contract {
    ...
    const FIELDS: &[Field] = &[
        Field {
            module: "clob::types::response",
            owner: "MidpointResponse",
            field: "mid",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        Field {
            module: "clob::types::response",
            owner: "PriceResponse",
        ...
        Field {
            module: "clob::types::response",
            owner: "OrderBookSummaryResponse",
        ...
        Field {
            ...
            ty: "Option<Decimal>",
            outcome: BlankOutcome::DefaultOnErrorSwallowsToNone,
        },
        Field {
            module: "clob::types::response",
            owner: "OrderSummary",
        ...
        Field {
            module: "clob::types::response",
            owner: "LastTradesPricesResponse",
            field: "price",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        ...
        Field {
            ...
            field: "fee_rate_bps",
            ty: "Option<Decimal>",
            outcome: BlankOutcome::AbsentAsNone,
        },
        Field {
            module: "clob::types::response",
            owner: "TradeResponse",
        ...
        Field {
            module: "clob::types::response",
            owner: "BalanceAllowanceResponse",
            field: "balance",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        ...
        Field {
            module: "clob::types::response",
            owner: "TotalUserEarningResponse",
            field: "earnings",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        ...
        Field {
            module: "clob::types::response",
            owner: "UserRewardsEarningResponse",
            field: "rewards_max_spread",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        Field {
        ...
        Field {
            module: "clob::ws::types::response",
            owner: "OrderBookLevel",
            field: "price",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        ...
        Field {
            module: "clob::ws::types::response",
            owner: "MidpointUpdate",
            field: "midpoint",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
        },
        Field {
            module: "data::types::response",
            owner: "Position",
            field: "size",
            ty: "Decimal",
            outcome: BlankOutcome::Rejects,
